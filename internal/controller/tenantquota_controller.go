...
// +kubebuilder:rbac:groups=agentrax.io,resources=tenantquotas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=agentrax.io,resources=tenantquotas/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=agentrax.io,resources=tenantquotas/finalizers,verbs=update
